...
| `run_orders.py` | The preset OpenRecon run orders for each block count, one per movement, written by `tools/make_run_orders.py`; do not edit by hand |
...
| `test_timing.py` | Checks that the countdown does not drift, without PsychoPy: `python3 src/test_timing.py` |
