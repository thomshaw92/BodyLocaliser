...
- **Balanced random has N! possible orders.** With the seven defaults that is 5040, and subjects 1 to 100 all get different orders. With five movements or fewer there are 120 or fewer, so different subjects will sometimes share one.
